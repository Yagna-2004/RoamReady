    ...
    <article>
      ...
      <section class="destination" id="destination">
        <div class="container">
          ...
          <button type="button" class="btn btn-primary">View All Destinations</button>
  ...
  <footer class="footer">
        ...
        <div class="footer-contact">
          ...
          <ul>
            ...
            <li class="contact-item">
              ...
              <a href="tel:+01123456789" class="contact-link">+01 (123) 4567 89</a>
            </li>

            <li class="contact-item">
              <ion-icon name="mail-outline"></ion-icon>

              <a href="mailto:info@roamready.com" class="contact-link">info@roamready.com</a>
            </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2024 <a href="#">RoamReady</a>. All rights reserved
        </p>
