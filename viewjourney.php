...
$dbname = "roamready_db";  // Change this to your database name
...
<html>
<head>
    <link rel="stylesheet" href="viewjourney.css">
    <title><?php echo $city; ?> Details</title>
</head>
<body> 
    <div class="navbar">
    <span class="logo">Roam Ready</span>
</div>
<div class="content-container">
    ...
    <footer>
    <p>&copy; 2024 Roam Ready. All rights reserved.</p>
</footer>
